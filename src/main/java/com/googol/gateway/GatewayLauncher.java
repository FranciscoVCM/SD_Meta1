...
public class GatewayLauncher {
    public static void main(String[] args) throws Exception {
        ...
        // --- Barrels: podes passar NOME/PORTA por args (como já tinhas),
        // e o HOST por env (com defaults sensatos).
        ...
        // Hosts por ENV (se estiveres em 2 máquinas, define B1_HOST/B2_HOST):
